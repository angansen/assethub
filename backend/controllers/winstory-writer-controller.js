...
exports.saveWinstory = (req, res) => {
    ...
    let winStory = {
        ...
        WINSTORY_REFERENCEABLE:req.body.WINSTORY_REFERENCEABLE,
        WINSTORY_SALES_LEAD:req.body.WINSTORY_SALES_LEAD,
        WINSTORY_ECA_ENGG_LEAD:req.body.WINSTORY_ECA_ENGG_LEAD,
        WINSTORY_CUSTOMER_LIFECYCLE:req.body.WINSTORY_CUSTOMER_LIFECYCLE,
        WINSTORY_REFERENCE_LANGUAGE_INCLUDED:req.body.WINSTORY_REFERENCE_LANGUAGE_INCLUDED,
        WINSTORY_PROPOSED_GOLIVE_DATE:req.body.WINSTORY_PROPOSED_GOLIVE_DATE,
        WINSTORY_CONSUMPTION_MILESTONE_USAGE_TARGET:req.body.WINSTORY_CONSUMPTION_MILESTONE_USAGE_TARGET,
        WINSTORY_REFERENCE_STATUS:req.body.WINSTORY_REFERENCE_STATUS,
        WINSTORY_CUSTOMER_CONTACT:req.body.WINSTORY_CUSTOMER_CONTACT,
        WINSTORY_REFERENCE_PLAN:req.body.WINSTORY_REFERENCE_PLAN,
        WINSTORY_REFERENCE_ASSET:req.body.WINSTORY_REFERENCE_ASSET,
        WINSTORY_NOTES:req.body.WINSTORY_NOTES
    }

    // console.log(JSON.stringify(winStory));
